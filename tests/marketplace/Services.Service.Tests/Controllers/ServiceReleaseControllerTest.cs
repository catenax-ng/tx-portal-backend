...
public class ServiceReleaseControllerTest
{
    ...
    public async Task GetAllInReviewStatusServiceAsync_ReturnsExpectedCount()
    {
        ...
        A.CallTo(() => _logic.GetAllInReviewStatusServiceAsync(A<int>._, A<int>._,A<OfferSorting?>._,null))
        ...
        //Assert
        A.CallTo(() => _logic.GetAllInReviewStatusServiceAsync(0, 15, null, null)).MustHaveHappenedOnceExactly();
