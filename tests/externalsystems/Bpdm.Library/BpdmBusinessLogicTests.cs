...
public class BpdmBusinessLogicTests
{
    ...
    public async Task PushLegalEntity_WithoutBpdmData_ThrowsUnexpectedConditionException()
    {
        ...
        var context = new IChecklistService.WorkerChecklistProcessStepData(IdWithBpn, checklist, Enumerable.Empty<ProcessStepTypeId>(), default);
    ...
    public async Task PushLegalEntity_WithBpn_ThrowsConflictException()
    {
        ...
        var checklist = new Dictionary<ApplicationChecklistEntryTypeId, ApplicationChecklistEntryStatusId>
            ...
            .ToImmutableDictionary();
        var context = new IChecklistService.WorkerChecklistProcessStepData(IdWithoutZipCode, checklist, Enumerable.Empty<ProcessStepTypeId>(), default);
    ...
    public async Task HandlePullLegalEntity_WithoutLegalEntity_ThrowsConflictException()
    {
        ...
        var checklist = new Dictionary<ApplicationChecklistEntryTypeId, ApplicationChecklistEntryStatusId>
            ...
            .ToImmutableDictionary();
        var context = new IChecklistService.WorkerChecklistProcessStepData(IdWithStateCreated, checklist, Enumerable.Empty<ProcessStepTypeId>(), default);
        SetupForHandlePullLegalEntity();
