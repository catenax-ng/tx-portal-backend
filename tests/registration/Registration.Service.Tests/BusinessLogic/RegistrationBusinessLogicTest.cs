...
public class RegistrationBusinessLogicTest
{
    ...
    public async Task SubmitRegistrationAsync_WithDocumentId_Success()
    {
        ...
        var sut = new RegistrationBusinessLogic(Options.Create(settings), null!, null!, null!, null!, _portalRepositories, _checklistService, _identityService, _dateTimeProvider);
    ...
    public async Task SubmitRegistrationAsync_WithoutUserEmail_DoesntSendMail()
    {
        ...
        var sut = new RegistrationBusinessLogic(Options.Create(settings), null!, null!, null!, A.Fake<ILogger<RegistrationBusinessLogic>>(), _portalRepositories, _checklistService, _identityService, _dateTimeProvider);
