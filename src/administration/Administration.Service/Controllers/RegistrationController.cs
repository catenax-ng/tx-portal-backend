...
public class RegistrationController : ControllerBase
{
    ...
    /// <returns>NoContent</returns>
    /// Example: POST: api/administration/registration/application/4f0146c6-32aa-4bb1-b844-df7e8babdcb4/trigger-clearinghouse <br />
    /// <response code="200">the result as a boolean.</response>
    ...
    [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status404NotFound)]
    public async Task<NoContentResult> TriggerClearinghouseChecklist([FromRoute] Guid applicationId)
    {
        await _logic.TriggerChecklistAsync(applicationId, ApplicationChecklistEntryTypeId.CLEARING_HOUSE).ConfigureAwait(false);
        return NoContent();
    }
    ...
    {
        await _logic.TriggerChecklistAsync(applicationId, ApplicationChecklistEntryTypeId.IDENTITY_WALLET).ConfigureAwait(false);
        return NoContent();
    }
    ...
    {
        await _logic.TriggerChecklistAsync(applicationId, ApplicationChecklistEntryTypeId.SELF_DESCRIPTION_LP).ConfigureAwait(false);
        return NoContent();
    }
    ...
    [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status404NotFound)]
    public async Task<NoContentResult> TriggerBpn([FromRoute] Guid applicationId)
    {
        await _logic.TriggerChecklistAsync(applicationId, ApplicationChecklistEntryTypeId.BUSINESS_PARTNER_NUMBER).ConfigureAwait(false);
        return NoContent();
    }
}
