...
/// <summary>
/// Implementation of <see cref="IAppBusinessValidation"/>.
/// </summary>
public class AppBusinessValidation : IAppBusinessValidation
{
    /// <summary>
    /// Constructor.
    /// </summary>
    public AppBusinessValidation()
    {
    }
    
    /// <inheritdoc/>
    public async Task<IEnumerable<LocalizedDescription>> ValidateAndGetAppDescription(Guid appId, string iamUserId, IOfferRepository offerRepository)
    {
