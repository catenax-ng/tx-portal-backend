...
public record AppUpdateModel(string? Title, string Provider, Guid? SalesManagerId, IEnumerable<Guid> UseCaseIds, IEnumerable<LocalizedDescription> Descriptions, IEnumerable<string> SupportedLanguageCodes, string Price, [ValidateEnumValues] IEnumerable<PrivacyPolicyId> PrivacyPolicies, string? ProviderUri, string? ContactEmail, string? ContactNumber);
