...
public class ServiceBusinessLogic : IServiceBusinessLogic
{
    ...
    public async Task UpdateServiceAsync(Guid serviceId, ServiceUpdateRequestData data, string iamUserId)
    {
        ...
        _offerService.UpsertRemoveOfferDescription(serviceId, data.Descriptions.Select(x => new LocalizedDescription(x.LanguageCode, x.LongDescription, x.ShortDescription)), serviceData.Descriptions);
