...
public interface IUserRepository
{
    ...
    Task<(Guid CompanyId, string Bpn, IEnumerable<Guid> TechnicalUserRoleIds)> GetCompanyIdAndBpnForIamUserUntrackedAsync(string iamUserId, string technicalUserClientId);
