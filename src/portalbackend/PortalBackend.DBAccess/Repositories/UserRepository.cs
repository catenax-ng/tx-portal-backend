...
public class UserRepository : IUserRepository
{
    ...
    public Task<(Guid CompanyId, string Bpn, IEnumerable<Guid> TechnicalUserRoleIds)> GetCompanyIdAndBpnForIamUserUntrackedAsync(string iamUserId, string technicalUserClientId) =>
        _dbContext.IamUsers
            .AsNoTracking()
            .Where(iamUser => iamUser.UserEntityId == iamUserId)
