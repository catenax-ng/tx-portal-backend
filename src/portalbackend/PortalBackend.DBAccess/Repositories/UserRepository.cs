...
public class UserRepository : IUserRepository
{
    ...
    /// <inheritdoc />
    public IAsyncEnumerable<(string? Email, string? Name, string? LastName)> GetCompanyUserInformationForCompanyAndRoleId(IEnumerable<Guid> userRoleIds, Guid companyId) =>
        _dbContext.CompanyUsers
            .Where(x => 
                x.CompanyId == companyId &&
                x.CompanyUserStatusId == CompanyUserStatusId.ACTIVE && 
