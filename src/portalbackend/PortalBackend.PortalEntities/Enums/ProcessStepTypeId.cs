...
public enum ProcessStepTypeId
{
    ...
    // MAILING
    SEND_MAIL = 401,
    RETRIGGER_SEND_MAIL = 402,

    // INVITATION
    INVITATION_SETUP_IDP = 501,
    INVITATION_CREATE_DATABASE_IDP = 502,
    INVITATION_CREATE_USER = 503,
    INVITATION_SEND_MAIL = 504,
    RETRIGGER_INVITATION_SETUP_IDP = 505,
    RETRIGGER_INVITATION_CREATE_USER = 506,
    RETRIGGER_INVITATION_CREATE_DATABASE_IDP = 507,
    RETRIGGER_INVITATION_SEND_MAIL = 508
}
