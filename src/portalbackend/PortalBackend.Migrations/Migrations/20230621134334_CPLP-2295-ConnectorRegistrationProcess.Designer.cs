...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20230621134334_CPLP-2295-ConnectorRegistrationProcess")]
    partial class CPLP2295ConnectorRegistrationProcess
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.AuditEntities.AuditConnector20230621", b =>
                {
                    b.Property<Guid>("AuditV1Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("RegistrationProcessId")
                        .HasColumnType("uuid")
                        .HasColumnName("registration_process_id");
                    ...
                    b.HasKey("AuditV1Id")
                        .HasName("pk_audit_connector20230621");

                    b.ToTable("audit_connector20230621", "portal");
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Connector", b =>
                {
                    ...
                    b.HasIndex("CertificateDocumentId")
                        .IsUnique()
                        .HasDatabaseName("ix_connectors_certificate_document_id");
                    ...
                    b.HasIndex("RegistrationProcessId")
                        .IsUnique()
                        .HasDatabaseName("ix_connectors_registration_process_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ProcessStepType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 200,
                            Label = "CALL_DAPS_AUTHENTICATION"
                        },
                        new
                        {
                            Id = 201,
                            Label = "START_REGISTER_CONNECTOR_SD"
                        },
                        new
                        {
                            Id = 202,
                            Label = "FINISH_REGISTER_CONNECTOR_SD"
                        });
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Connector", b =>
                {
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Document", "CertificateDocument")
                        .WithOne("CertificateConnector")
                        .HasForeignKey("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Connector", "CertificateDocumentId")
                        .HasConstraintName("fk_connectors_documents_certificate_document_id");
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Process", "RegistrationProcess")
                        .WithOne("Connector")
                        .HasForeignKey("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Connector", "RegistrationProcessId")
                        .HasConstraintName("fk_connectors_processes_registration_process_id");

                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Document", "SelfDescriptionDocument")
                        .WithOne("SelfDescriptionConnector")
                    ...
                    b.Navigation("RegistrationProcess");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Document", b =>
                {
                    ...
                    b.Navigation("CertificateConnector");

                    b.Navigation("Companies");

                    b.Navigation("Consents");

                    b.Navigation("SelfDescriptionConnector");
                });
