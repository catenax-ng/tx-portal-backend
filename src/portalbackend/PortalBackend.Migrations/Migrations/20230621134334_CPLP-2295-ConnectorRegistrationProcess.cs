...
{
    public partial class CPLP2295ConnectorRegistrationProcess : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registration_process_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_audit_connector20230621", x => x.audit_v1id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 14, "DAPS_CERTIFICATE" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 200, "CALL_DAPS_AUTHENTICATION" },
                    { 201, "START_REGISTER_CONNECTOR_SD" },
                    { 202, "FINISH_REGISTER_CONNECTOR_SD" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                table: "process_types",
                columns: new[] { "id", "label" },
                values: new object[] { 2, "CONNECTOR_REGISTRATION" });

            migrationBuilder.CreateIndex(
                name: "ix_connectors_certificate_document_id",
                schema: "portal",
                table: "connectors",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_connectors_registration_process_id",
                schema: "portal",
                table: "connectors",
                column: "registration_process_id",
                unique: true);

            migrationBuilder.AddForeignKey(
                name: "fk_connectors_documents_certificate_document_id",
                schema: "portal",
                table: "connectors",
                column: "certificate_document_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_connectors_processes_registration_process_id",
                schema: "portal",
                table: "connectors",
                column: "registration_process_id",
                principalSchema: "portal",
