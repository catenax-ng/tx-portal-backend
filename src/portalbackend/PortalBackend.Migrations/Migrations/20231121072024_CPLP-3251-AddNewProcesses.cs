...
{
    /// <inheritdoc />
    public partial class CPLP3251AddNewProcesses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 401, "SEND_MAIL" },
                    { 402, "RETRIGGER_SEND_MAIL" },
                    { 501, "INVITATION_SETUP_IDP" },
                    { 502, "INVITATION_CREATE_DATABASE_IDP" },
                    { 503, "INVITATION_CREATE_USER" },
                    { 504, "INVITATION_SEND_MAIL" },
                    { 505, "RETRIGGER_CREATE_IDP" },
                    { 506, "RETRIGGER_CREATE_USER" },
                    { 507, "RETRIGGER_CREATE_DATABASE_IDP" },
                    { 508, "RETRIGGER_INVITATION_SEND_MAIL" }
                });
